...
export const BUILDINGS = [{
    ...
    description: "Software engineering is the application of engineering to the development of software in a systematic method",
    initialCost: 12000,
    cost: 12000,
    visibleAfter: 1000,
    income: 450
    ...
    description: "Most important person in the company.",
    initialCost: 1.4e6,
    cost: 1.4e6,
    visibleAfter: 100000,
    income: 14000
