...
const Building = ({building, onBuildingClick, canAfford}) => (
  <div className="media building" onClick={onBuildingClick} style={{'opacity': canAfford ? 1.0 : 0.5}}>
    ...
    <div className="media-body">
      <h4 className="media-heading">{building.name}</h4>
      ...
      <span style={{display: "inline-block"}} className="label label-success">Income +{ building.count * building.income * building.incomeFactor}</span>
